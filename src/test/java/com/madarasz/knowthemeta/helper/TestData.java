...
public class TestData {
    ...
    public TestData() {
        testCycle1 = new CardCycle("test", "First Test Cycle", 9998, true);
        testCycle2 = new CardCycle("test_re", "Test Reprint Cycle", 9999, true);
        try {
        ...
        testCard2 = new Card(2, 1, "anarch", 0, 15, 45, 1, 2, 0, 0, 0, "G-mod", "runner", "Whenever you install a <strong>virus</strong> program, the Corp trashes the top card of R&D.", "Test Anarch", "identity", false, 0);
        testCardInPack1 = new CardInPack(testCard1, testPack1, "66661", "https://netrunnerdb.com/card_image/01007.png");
        testCardInPack2 = new CardInPack(testCard2, testPack2, "66662", "https://netrunnerdb.com/card_image/01001.png");
        testCardInPack3 = new CardInPack(testCard1, testPack3, "99991", "https://netrunnerdb.com/card_image/25010.png");
